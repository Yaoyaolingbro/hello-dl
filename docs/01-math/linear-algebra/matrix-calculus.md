...
![梯度方向场示意](https://upload.wikimedia.org/wikipedia/commons/thumb/0/0f/Gradient2.svg/600px-Gradient2.svg.png)

*标量函数 $f(x,y)$ 的等高线（橙色）和梯度向量场（蓝色箭头）：梯度始终垂直于等高线，指向函数值增大最快的方向。来源：[Wikipedia](https://en.wikipedia.org/wiki/Gradient)*
