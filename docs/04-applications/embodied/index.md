...
让机器人能感知、规划、执行。这一章从经典控制讲到 VLA 模型和世界模型，是 RL、视觉、语言的交汇点。

## 你将学到

| 小节 / 章节 | 核心内容 | 前置依赖 |
|-------------|----------|----------|
| [传统运动控制算法](classical-control/index.md) | 运动学、动力学、轨迹规划 | SO(3)/SE(3) |
| [模仿学习（应用层）](imitation-learning.md) | 数据采集、遥操作、策略部署 | Part 3 模仿学习 |
| [导航](navigation.md) | 视觉导航、语言指令导航 | CNN、RL |
